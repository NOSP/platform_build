...
dependency_filename = 'nosp.dependencies'
repositories = []
local_manifests = []
...
if not depsonly:
    print "Device %s not found. Attempting to retrieve device repository from NOSP Github (http://github.com/NOSP)." % device
...
page = 1
while not depsonly:
    githubreq = urllib2.Request("https://api.github.com/users/NOSP/repos?per_page=100&page=%d" % page)
    add_auth(githubreq)
...
def add_to_manifest(repositories):
    for repository in repositories:
        if 'dep_type' in repository:
            ...
            print 'dep_type not found, assuming device tree, otherwise please update your nosp.dependencies config'
...
print "Repository for %s not found in the NOSP Github repository list. If this is in error, you may need to manually add it to your local_manifests." % device
